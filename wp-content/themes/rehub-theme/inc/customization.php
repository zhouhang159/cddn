...
<?php if(rehub_option('body_font_size')) : ?>
	...
	?>
	article, .post, body .post-readopt .post-inner, body .post-readopt:not(.main-side), body .post-readopt .post {
...
.search-header-contents{background-color: <?php echo hex2rgba($maincolor, 0.96); ?>; }
