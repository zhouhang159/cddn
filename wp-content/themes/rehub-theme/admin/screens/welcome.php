			...
			<?php if(!$registeredlicense) : ?>
				...
				<?php if(!empty($activationmessage)):?>
					...
					<?php if(stripos($activationmessage, 'License is already active on maximum') === 0 && $licode && $liuser):?>
						...
						<p>
							<span><strong><?php esc_html_e( "One license can be active only on one site.", "rehub-theme" ); ?></strong><br><?php esc_html_e( "You can use extension packs to get bonus licenses to add more sites. After purchase, please, use this", "rehub-theme");?> <a href="https://wpsoul.com/extended-license-request/" target="_blank"><?php esc_html_e('Request form', 'rehub-theme');?></a> <?php esc_html_e( "and provide list of purchased licenses which you want to extend. Please, note that all your purchased licenses must be activated on sites before sending request for extending licenses.", "rehub-theme" ); ?></span><br>
						</p>
						<div style=" margin-top:20px; border-radius:15px; display:flex;">
							<div style="border:1px solid #eee; padding:15px;flex-grow:1;">
								...
								<div style="font-size:18px;font-weight:bold">Buy +1 more</div>
								<div style="font-size:15px; margin-top:8px;">and Get <strong style="color:#8234e4">5</strong> licenses in Total</div>
								</a>
							</div>
							<div style="border:1px solid #eee; padding:15px;flex-grow:1;margin:0 15px">
								...
								<div style="font-size:18px;font-weight:bold">Buy +2 more</div>
								<div style="font-size:15px; margin-top:8px">and Get <strong style="color:#8234e4">10</strong> licenses in Total</div>
								</a>
							</div>
							<div style="border:1px solid #eee; padding:15px;flex-grow:1">
								<a href="https://1.envato.market/n1LqK7" target="_blank" style="color:#444; text-decoration:none">
								<div style="float: left;font-size: 40px;margin-bottom: 5px;margin-right: 20px;color: #ff9800;"><i class="rhicon rhi-crown"></i></div>
								<div style="font-size:18px;font-weight:bold">Buy +9 more</div>
								<div style="font-size:15px; margin-top:8px">and Get <strong style="color:#8234e4">100</strong> licenses in Total</div>
								</a>
							</div>					
						</div>
