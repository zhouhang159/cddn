...
//////////////////////////////////////////////////////////////////
// Youtube real lazy load
//////////////////////////////////////////////////////////////////
function rh_youtube_lazy_load_real( $block_content, $block ) {
    if ( isset( $block['attrs']['type'] ) && 'video' === $block['attrs']['type'] ) {
		wp_enqueue_script('rhyall');
		$block_content = preg_replace('(src="(.*?)")', 'src="" data-src="$1" class="lazyyall"', $block_content);
    }
    return $block_content;
}
add_filter( 'render_block_core/embed', 'rh_youtube_lazy_load_real', 10, 2 );
