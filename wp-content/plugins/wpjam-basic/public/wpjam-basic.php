...
class WPJAM_Basic{
	...
	public function load_basic_page(){
		...
		$disabled_fields	= $this->parse_fields([
			...
			'disable_emoji'				=>['title'=>'屏蔽Emoji图片',		'slug'=>'diable-emoji',						'description'=>'屏蔽Emoji图片转换功能，直接使用Emoji文字。'],
			'disable_texturize'			=>['title'=>'屏蔽字符转码',		'slug'=>'disable-wptexturize',				'description'=>'屏蔽字符换成格式化的 HTML 实体功能。'],
			...
			'disable_autoembed'			=>['title'=>'屏蔽Auto Embeds',	'slug'=>'disable-auto-embeds-in-wordpress',	'description'=>'禁用 Auto Embeds 功能，加快页面解析速度。'],
			'disable_post_embed'		=>['title'=>'屏蔽文章Embed',		'slug'=>'disable-wordpress-post-embed',		'description'=>'屏蔽嵌入其他 WordPress 文章的Embed功能。'],
		...
		$speed_fields		= [
			...
			'frontend_optimization'	=>['title'=>'前端页面优化',	'type'=>'fieldset',	'fields'=>$this->parse_fields([
			...
			'backend_optimization'	=>['title'=>'后台界面优化',	'type'=>'fieldset',	'fields'=>$this->parse_fields([
		...
		$enhance_fields		= [
			...
			'no_category_base_set'	=>['title'=>'简化分类链接',	'type'=>'fieldset',	'fields'=>[
				'no_category_base'		=>$this->parse_field(['slug'=>'wordpress-no-category-base',	'description'=>'去掉分类目录链接中的category或者自定义分类的%taxonomy%。']),
