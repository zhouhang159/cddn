...
class WPJAM_Thumbnail{
	...
	public function get_option_setting(){
		...
		$term_fields	= [
			...
			'term_thumbnail_size'		=> ['title'=>'缩略图尺寸',	'type'=>'fieldset',	'show_if'=>['key'=>'term_thumbnail_type', 'compare'=>'!=', 'value'=>''],'group'=>true,	'fields'=>[
				'term_thumbnail_width'	=> ['title'=>'',	'type'=>'number',	'class'=>'small-text'],
				'term_thumbnail_plus'	=> ['title'=>'',	'type'=>'view',		'value'=>'<span class="dashicons dashicons-no-alt"></span>'],
				'term_thumbnail_height'	=> ['title'=>'',	'type'=>'number',	'class'=>'small-text']
			]]
		];

		$post_fields	= [
			'post_thumbnail_orders'	=> ['title'=>'获取顺序',	'type'=>'mu-fields',	'group'=>true,	'max_items'=>5,	'fields'=>[
	...
	public function on_admin_head(){
		$taxonomies			= get_taxonomies(['show_ui'=>true, 'public'=>true],'objects');
		$taxonomy_options	= array_column($taxonomies, 'label', 'name');
