...
class WPJAM_Related_Posts{
	...
	public function load_option_page(){
		...
		$show_if_thumb	= ['key'=>'thumb', 'value'=>1];
		...
		$fields	= [
			...
			'thumb_set'		=> ['title'=>'列表内容',	'type'=>'fieldset',	'fields'=>[
				'_excerpt'	=> ['title'=>'',	'type'=>'checkbox',	'name'=>'excerpt',	'description'=>'显示文章摘要。'],
				'thumb'		=> ['title'=>'',	'type'=>'checkbox',	'value'=>1,	'group'=>'size',		'description'=>'显示缩略图。'],
				'size'		=> ['title'=>'',	'type'=>'view',		'show_if'=>$show_if_thumb,	'group'=>'size',	'value'=>'尺寸：'],
				'width'		=> ['title'=>'',	'type'=>'number',	'show_if'=>$show_if_thumb,	'group'=>'size',	'value'=>100,	'class'=>'small-text'],
				'x'			=> ['title'=>'',	'type'=>'view',		'show_if'=>$show_if_thumb,	'group'=>'size',	'value'=>'<span class="dashicons dashicons-no-alt"></span>'],
				'height'	=> ['title'=>'',	'type'=>'number',	'show_if'=>$show_if_thumb,	'group'=>'size',	'value'=>100,	'class'=>'small-text'],
				'_view'		=> ['title'=>'',	'type'=>'view',		'show_if'=>$show_if_thumb,	'value'=>'如勾选之后缩略图不显示，请到「<a href="'.admin_url('admin.php?page=wpjam-thumbnail').'">缩略图设置</a>」勾选「无需修改主题，程序自动使用 WPJAM 的缩略图设置」。']
			]],
