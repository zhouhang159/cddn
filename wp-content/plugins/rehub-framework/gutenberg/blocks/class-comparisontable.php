...
class ComparisonTable extends Basic {
	...
	protected function render( $settings = array(), $inner_content='' ) {
		...
		ob_start();
	?>
		<div class="<?php echo ''.$alignclass;?>comparison-table <?php echo $settings['responsiveView'] ==='slide' ? 'swiper-container' : ''; ?> <?php echo $settings['responsiveView']; ?> <?php echo $settings['enableBadges'] ? 'has-badges' : ''; ?>" data-table-type="<?php echo $settings['responsiveView']; ?>">
