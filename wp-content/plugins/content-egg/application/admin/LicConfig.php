    ...
    protected function options()
    {
        return array(
            'license_key' => array(
                ...
                'description' => __('Please enter your license key.', 'content-egg') . ' ' . sprintf(__('You can find your key on the %s page.', 'external-importer'), '<a href="' . \esc_url(Plugin::panelUri) . '" target="_blank">My Account</a>'),
